    ...
    <main className="flex justify-center items-center min-h-screen w-[640] bg-blue-50">
      <div className="flex flex-col items-center place-items-center p-20 gap-y-4 rounded-xl bg-white border-2 border-blue-400">
        <div className="flex flex-col place-items-center pb-4">
          <h1 className="font-heading place-self-center text-6xl font-bold text-black">
            AINGS
          </h1>
          <p className="font-body text-lg place-self-center text-center text-black">
            Automatic Indonesian News Generation System
          </p>
        </div>

        <h1 className="font-heading place-self-center text-2xl font-bold pb-4 text-black">
          Masuk
        </h1>
