                ...
                <div className="flex flex-row justify-end items-center gap-5">
                    <div className="flex flex-row">
                        <button disabled={true}
                            className="flex-shrink-0 z-10 inline-flex items-center py-3 px-5 text-sm 
                        ...
                        <select id="draft-save-options" value={saveToNew} onChange={setSaveToNew}
                            className="bg-gray-50 border border-gray-300 font-body
                                text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full py-3 px-5">
                    ...
                    <button
                        ...
                        className='font-body self-stretch py-3 px-5 border-2 text-white bg-blue-600 rounded-lg hover:bg-blue-400'>Simpan
                    </button>
                </div>
            </div>
        </div>
